package com.sprtcoding.tourizal.LGU;
...
import com.sprtcoding.tourizal.LGU.Menu.LGUHomeFragment;
...
public class LGUDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lgudashboard);
        ...
        if(savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new LGUHomeFragment()).commit();
            navigationView.setCheckedItem(R.id.nav_home);
        }

        LayoutInflater li = LayoutInflater.from(this);
        dots = (TextView) li.inflate(R.layout.notification_dot, null);
        navigationView.getMenu().findItem(R.id.nav_postRequest).setActionView(dots);

        resortColRef.whereEqualTo("POST_TYPE", "Pending").addSnapshotListener((value, error) -> {
        ...
        FirebaseMessaging.getInstance().getToken()
                .addOnCompleteListener(task1 -> {
                    if (!task1.isSuccessful()) {
                        Toast.makeText(LGUDashboard.this, "Fetching FCM registration token failed :" + task1.getException(), Toast.LENGTH_SHORT).show();
                        return;
                    }
        ...
        if(mAuth.getCurrentUser() != null) {
            userRef.child(mAuth.getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(LGUDashboard.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
